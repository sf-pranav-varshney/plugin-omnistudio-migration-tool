...
import { OMNIDEF } from './autoReusableDriverInputEnglish_def.js';
import tmpl from './autoReusableDriverInputEnglish.html';
import tmpl_nds from './autoReusableDriverInputEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class autoReusableDriverInputEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
