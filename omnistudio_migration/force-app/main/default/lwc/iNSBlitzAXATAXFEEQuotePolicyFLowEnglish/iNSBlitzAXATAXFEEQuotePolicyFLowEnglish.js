...
import { OMNIDEF } from './iNSBlitzAXATAXFEEQuotePolicyFLowEnglish_def.js';
import tmpl from './iNSBlitzAXATAXFEEQuotePolicyFLowEnglish.html';
import tmpl_nds from './iNSBlitzAXATAXFEEQuotePolicyFLowEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class iNSBlitzAXATAXFEEQuotePolicyFLowEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
