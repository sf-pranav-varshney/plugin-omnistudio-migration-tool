...
import { OMNIDEF } from './iNSBlitzCreateOppQuotePolicyWithRatingDate_CCEnglish_def.js';
import tmpl from './iNSBlitzCreateOppQuotePolicyWithRatingDate_CCEnglish.html';
import tmpl_nds from './iNSBlitzCreateOppQuotePolicyWithRatingDate_CCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class iNSBlitzCreateOppQuotePolicyWithRatingDate_CCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
