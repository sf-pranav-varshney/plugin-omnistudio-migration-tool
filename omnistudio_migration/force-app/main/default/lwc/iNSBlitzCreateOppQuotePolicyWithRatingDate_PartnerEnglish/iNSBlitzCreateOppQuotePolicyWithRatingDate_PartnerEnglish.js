...
import { OMNIDEF } from './iNSBlitzCreateOppQuotePolicyWithRatingDate_PartnerEnglish_def.js';
import tmpl from './iNSBlitzCreateOppQuotePolicyWithRatingDate_PartnerEnglish.html';
import tmpl_nds from './iNSBlitzCreateOppQuotePolicyWithRatingDate_PartnerEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class iNSBlitzCreateOppQuotePolicyWithRatingDate_PartnerEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
