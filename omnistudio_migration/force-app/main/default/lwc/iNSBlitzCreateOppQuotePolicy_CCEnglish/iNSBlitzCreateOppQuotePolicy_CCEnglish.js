...
import { OMNIDEF } from './iNSBlitzCreateOppQuotePolicy_CCEnglish_def.js';
import tmpl from './iNSBlitzCreateOppQuotePolicy_CCEnglish.html';
import tmpl_nds from './iNSBlitzCreateOppQuotePolicy_CCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class iNSBlitzCreateOppQuotePolicy_CCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
