...
import { OMNIDEF } from './iNSBlitzCreateOppQuotePolicy_PartnerEnglish_def.js';
import tmpl from './iNSBlitzCreateOppQuotePolicy_PartnerEnglish.html';
import tmpl_nds from './iNSBlitzCreateOppQuotePolicy_PartnerEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class iNSBlitzCreateOppQuotePolicy_PartnerEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
