...
import { OMNIDEF } from './iNSBlitzModifyPolicyEnglish_def.js';
import tmpl from './iNSBlitzModifyPolicyEnglish.html';
import tmpl_nds from './iNSBlitzModifyPolicyEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class iNSBlitzModifyPolicyEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
