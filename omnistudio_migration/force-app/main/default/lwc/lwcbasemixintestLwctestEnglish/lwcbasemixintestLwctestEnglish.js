...
import { OMNIDEF } from './lwcbasemixintestLwctestEnglish_def.js';
import tmpl from './lwcbasemixintestLwctestEnglish.html';
import tmpl_nds from './lwcbasemixintestLwctestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lwcbasemixintestLwctestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
