...
import { OMNIDEF } from './lwcquoteAutoEnglish_def.js';
import tmpl from './lwcquoteAutoEnglish.html';
import tmpl_nds from './lwcquoteAutoEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class lwcquoteAutoEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
