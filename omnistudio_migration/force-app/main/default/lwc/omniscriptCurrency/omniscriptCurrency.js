...
import tmpl from './omniscriptCurrency.html';
...
export default class OmniscriptCurrency extends OmniscriptAtomicElement {
    ...
    initCompVariables() {
        ...
        this._repeatCurrencyAlternativeText = this.allCustomLabelsUtil.OmniCurrencyRepeatAltText.replace(/\{0\}/gi, this._propSetMap.label);
        this._removeCurrencyAlternativeText = this.allCustomLabelsUtil.OmniCurrencyRemoveAltText.replace(/\{0\}/gi, this._propSetMap.label);
    }
