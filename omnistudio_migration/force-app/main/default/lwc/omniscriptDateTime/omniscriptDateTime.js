...
import { dateFormatCompatability, timeFormatCompatability, parseChronoAttributes, isTimeZoneValid } from 'c/omniscriptUtils';
...
export default class OmniscriptDateTime extends OmniscriptAtomicElement {
    ...
    get defaultValue() {
        ...
        if (dfltValue && result === dfltValue && this._timezone) {
            const parsedDate = dayjs(dfltValue, `${this._dateFormat} ${this._timeFormat}`).utc(true);
