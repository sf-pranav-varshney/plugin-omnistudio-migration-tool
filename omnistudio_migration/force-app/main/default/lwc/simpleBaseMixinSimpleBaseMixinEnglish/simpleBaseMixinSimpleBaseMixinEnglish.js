...
import { OMNIDEF } from './simpleBaseMixinSimpleBaseMixinEnglish_def.js';
import tmpl from './simpleBaseMixinSimpleBaseMixinEnglish.html';
import tmpl_nds from './simpleBaseMixinSimpleBaseMixinEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class simpleBaseMixinSimpleBaseMixinEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
